...
class wordThread:
	def __init__(self,wording,prevWord,prevPrevWord,nextWord,nextNextWord):
		...
		self.finalSentence=str(self.tagWord+" "+self.mainWord+" "+self.firstThree + " " + self.lastThree + " " + self.nextWord + " " + self.nextNextWord +" " +self.prevWord + " " + self.prevPrevWord +"\n")
...
if __name__=="__main__":
	readText(sys.argv[1],"posTrain.file")
	formModel("posTrain.file",sys.argv[2])
